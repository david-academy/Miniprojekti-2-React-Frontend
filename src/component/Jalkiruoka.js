...
class Jalkiruoka extends Component {
    ...
    refreshRecipes() {
        RecipeDataService.retrieveAllJalkiruokaRecipes(INSTRUCTOR)//HARDCODED
            .then(
                response => {
